...
### 4.	Secret and Public Keys

This is where all the magic of ECDSA (Elliptic Curve Digital Signature Algorithm) happens. Let me add that I use a particular epiliptic curve called secp256k1.
...
### 7.	Encryption and decryption of messages
